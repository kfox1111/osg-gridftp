...
if [ "x$SAVE_LCMAPS_DB_FILE" -ne "x" ]; then export LCMAPS_DB_FILE="$SAVE_LCMAPS_DB_FILE"; fi
if [ "x$SAVE_LCMAPS_POLICY_NAME" -ne "x" ]; then export LCMAPS_POLICY_NAME="$SAVE_LCMAPS_POLICY_NAME"; fi
if [ "x$SAVE_LLGT_LIFT_PRIVILEGED_PROTECTION" -ne "x" ]; then export LLGT_LIFT_PRIVILEGED_PROTECTION="$SAVE_LLGT_LIFT_PRIVILEGED_PROTECTION"; fi
if [ "x$SAVE_LCMAPS_DEBUG_LEVEL" -ne "x" ]; then export LCMAPS_DEBUG_LEVEL="$SAVE_LCMAPS_DEBUG_LEVEL"; fi
